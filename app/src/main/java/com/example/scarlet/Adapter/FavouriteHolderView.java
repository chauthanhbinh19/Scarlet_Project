...
public class FavouriteHolderView extends RecyclerView.ViewHolder {
    ImageView imageView,imageView2, add_btn,btnDelete;
    TextView textView1,textView2;
    Context context;
    String productKey, categoryName, size;
    private FavouriteAdapter favouriteAdapter;
    public FavouriteHolderView linkAdapter(FavouriteAdapter favouriteAdapter1){
        this.favouriteAdapter=favouriteAdapter1;
        return this;
    }

    public FavouriteHolderView(@NonNull View itemView) {
        super(itemView);
                        ...
                        if(snapshot.exists()){
                            for(DataSnapshot snap: snapshot.getChildren()){
                                if(snap.child("productId").getValue(String.class).equals(productKey)){
                                    ...
                                    favouriteAdapter.productList.remove(getAdapterPosition());
